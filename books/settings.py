...
# SOCIAL_AUTH_POSTGRES_JSONFIELD = True # UserWarning: SOCIAL_AUTH_POSTGRES_JSONFIELD has been
# renamed to SOCIAL_AUTH_JSONFIELD_ENABLED and will be removed in the next release.
